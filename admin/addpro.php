                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Add Courses</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="subcourse">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="ctitle" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Course Title">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="duration" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Duration. eg: (6 months) or (1 year)">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="arequirement" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Admission requirement">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="location" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Location/Mode . eg : Online, Main Campus(offline)  ">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="fees" type="number" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Fees for this course  ">
                                    </div>
                                  ...
                                  <div class="form-group mb-4">
                                        <label for="exampleFormControlTextarea1">Enter Course Structure Below</label>
                                        <textarea name="structure" class="form-control-rounded form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    </div>


                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlTextarea1">Enter Course Description Below</label>
                                        <textarea name="description" class="form-control-rounded form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    </div>
